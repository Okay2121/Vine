...
def admin_view_all_users_handler_legacy(update, chat_id):
    ...
    # This is a legacy implementation that has been replaced by the enhanced version above
    # Forward to the active implementation to avoid duplicate functionality
    return admin_view_all_users_handler(update, chat_id)
