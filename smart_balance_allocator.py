    ...
    try:
        if trade_type == 'buy':
            ...
            message = (
                ...
                f"*Transaction embedded:* [View on Solscan]({getattr(position, 'buy_tx_hash', 'solscan.io/tx/ac123')})\n"
                f"*Status:* Holding\n"
            ...
            message = (
                ...
                f"*Transaction embedded:* [View on Solscan]({getattr(position, 'sell_tx_hash', 'solscan.io/tx/def456')})\n"
                f"*Status:* Completed\n"
    ...
    try:
        if trade_type == "buy":
            ...
            message = (
                ...
                f"Transaction embedded: {position.buy_tx_hash}\n"
                f"Status: Holding\n"
                f"Comment: {comment}\n\n"
            ...
            message = (
                ...
                f"Transaction embedded: {position.sell_tx_hash}\n"
                f"Status: Completed\n\n"
